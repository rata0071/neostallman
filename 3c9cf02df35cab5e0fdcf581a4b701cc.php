...
<div class="row-fluid">
	...
	<?php } else { ?>
	<img src="/img/stallman-aburrido.jpg" />
	...
	<p><strong>- De todas formas, para cualquier misión necesitaras un nivel 3 de conocimiento de Internet...</strong> 
	...
	<p>¿Ehh, una prueba? te decis para adentro pero recordas que ya la cagaste con eso del Window$.</p>
...
<input class="btn submit btn-inverse" type="submit" value="Responder" />
	...
	<p>Internet esta construida sobre el <strong>protocolo TCP/IP</strong>.</p>
	...
	<p>Un paquete tendrá la ip y puerto de origen, la ip y puerto de destino, el tipo y más cosas que podes averiguar por tu cuenta.</p>
